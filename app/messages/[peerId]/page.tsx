...
export default async function MessageThreadPage({ params }: ThreadPageProps) {
  ...
  return (
    <div className="home-page-root message-thread-page-root flex h-dvh flex-col overflow-hidden">
      <Navbar authenticated />
      <main className="home-main-shell message-thread-page feed-page flex min-h-0 flex-1 flex-col overflow-hidden py-0 md:py-6">
        <div className="message-thread-page-inner mx-auto flex min-h-0 w-full max-w-2xl flex-1 flex-col max-md:px-0 md:px-3 sm:px-4">
