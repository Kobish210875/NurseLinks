 ...
 * shell (Navbar, tab bar) and the {children} browse skeleton are already
 * visible to the user.
 *
...
/**
 * Layout shell — Navbar + tab skeletons are sent as the first RSC chunk
 * before any Supabase work begins.
 */
